...
public class OperationSupport {
    ...
    public OperationSupport(OperationContext ctx) {
        this.context = ctx;
        System.out.println("--------" + ctx.getApiGroupName());
        System.out.println("--------" + ctx.getConfig().getApiVersion());
        System.out.println("--------" + ctx.getClient());
    ...
    public URL getRootUrl() {
        System.out.println("GNAME:" + apiGroupName);
        System.out.println("master url:" + config.getMasterUrl());
        System.out.println("GVERSION:" + apiGroupVersion);

        //tmp hack
        if(apiGroupName == null || apiGroupName.isEmpty()){
            apiGroupName = "radanalytics.io";
        }
        if(apiGroupVersion == null || apiGroupVersion.isEmpty()){
            apiGroupVersion = "v1";
        }

        try{
            URLUtils.join(config.getMasterUrl().toString(), "apis", apiGroupName, apiGroupVersion);
